...
const Experience = () => {
  ...
  return (
    <section id="experience" className="section-padding bg-cinema-gray relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-cinema-blue/5 rounded-full filter blur-3xl"></div>
