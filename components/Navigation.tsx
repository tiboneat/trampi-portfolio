...
const Navigation = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Menu - SORTI DU NAV pour éviter les problèmes de stacking context */}
      {isMobileMenuOpen && (
        <div 
          id="mobile-menu"
          className="md:hidden fixed inset-0 top-0 bg-theme-primary/98 backdrop-blur-lg overflow-y-auto z-[10001]"
